...
console.log(`CURSOR_API_KEY: ${cfg.cursorApiKey ? "✓" : "✗ (可用 agent login)"}`)
console.log(`CURSOR_MODEL: ${cfg.cursorModel || "(未设置)"}`)
console.log(`KIRO_API_KEY: ${cfg.kiroApiKey ? "✓" : "✗ (可用 kiro-cli login)"}`)
console.log(`KIRO_MODEL: ${cfg.kiroModel || "(未设置)"}`)
console.log(`KIRO_EFFORT: ${cfg.kiroEffort || "(未设置)"}`)
